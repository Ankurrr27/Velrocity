  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-transparent text-zinc-900 dark:text-white flex-1">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div
          className="absolute -right-24 top-0 h-96 w-96 rounded-full blur-[100px]"
          style={{ backgroundColor: "rgba(var(--primary), 0.15)" }}
        />
        <div className="absolute top-1/2 left-0 h-[30rem] w-[30rem] rounded-full bg-indigo-500/10 blur-[100px]" />
      </div>
